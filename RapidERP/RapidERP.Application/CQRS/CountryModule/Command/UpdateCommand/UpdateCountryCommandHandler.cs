...
namespace RapidERP.Application.CQRS.CountryModule.request.Updaterequest;
...
public class UpdateCountryrequestHandler(ICountryBService service)
{
    ...
    public async Task<RequestResponse> Handle(UpdateCountryCommand request)
    {
        //try
        //{
        ...
        //        request.masterPUT.RegionId = (request.masterPUT.RegionId != 0) ? request.masterPUT.RegionId : masterRecord.RegionId;
        //        request.masterPUT.StateId = (request.masterPUT.StateId != 0) ? request.masterPUT.StateId : masterRecord.StateId;
        //        request.masterPUT.TimeZoneId = (request.masterPUT.TimeZoneId != 0) ? request.masterPUT.TimeZoneId : masterRecord.TimeZoneId;
        //    }
        ...
        //        masterRecord.RegionId = request.masterPUT.RegionId;
        //        masterRecord.StateId = request.masterPUT.StateId;
        //        masterRecord.TimeZoneId = request.masterPUT.TimeZoneId;
        ...
        //        history.RegionId = request.masterPUT.RegionId;
        //        history.StateId = request.masterPUT.StateId;
        //        history.TimeZoneId = request.masterPUT.TimeZoneId;
        ...
        var result = await service.Update(request.masterPUT);
        return result;
    }
}
