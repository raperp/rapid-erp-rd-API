...
public class UpdateMessageModuleCommandHandler(IRepository repository)
{
    UpdateMessageModuleCommandResponseModel _response;

    public async Task<UpdateMessageModuleCommandResponseModel> Handle(UpdateMessageModuleCommandRequestModel request)
    {
        try
        {
            ...
            {
                request.masterPUT.TextModuleId = (request.masterPUT.TextModuleId != 0) ? request.masterPUT.TextModuleId : masterRecord.TextModuleId;
            ...
            if (isExists == false)
            {
                masterRecord.TextModuleId = request.masterPUT.TextModuleId;
