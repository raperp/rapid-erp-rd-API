...
public class CreateSingleStatusTypeCommandHandler(IRepository repository)
{
    public async Task<CreateSingleStatusTypeCommandResponseModel> Handle(CreateSingleStatusTypeCommandRequestModel request)
    {
        CreateSingleStatusTypeCommandResponseModel _response; 
