...
namespace RapidERP.Application.Validator.CountryValidator;

public class CountryPOSTRequestValidator : AbstractValidator<CountryPOSTRequestDTO>
{
    public CountryPOSTRequestValidator()
    {
        RuleFor(x => x.Name)
            .NotEmpty()
