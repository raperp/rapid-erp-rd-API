...
public class TenantHistoryConfiguration : IEntityTypeConfiguration<TenantHistory>
{
    public void Configure(EntityTypeBuilder<TenantHistory> builder)
    {
        ...
        builder.Property(x => x.TenantId).IsRequired(false).HasColumnOrder(1);
        ...
        builder.Property(x => x.LicenseNumber).HasMaxLength(20).HasColumnOrder(18);
        builder.Property(x => x.LimitUsers).HasMaxLength(4).HasColumnOrder(19);
        builder.Property(x => x.ERPPlan).HasMaxLength(20).HasColumnOrder(20);
        builder.Property(x => x.IssueAt).HasColumnOrder(21);
        ...
        builder.Property(x => x.Latitude).HasPrecision(9, 6).HasColumnOrder(34);
        builder.Property(x => x.Longitude).HasPrecision(9, 6).HasColumnOrder(35);
        builder.Property(x => x.ActionBy).HasColumnOrder(36);
        builder.Property(x => x.ActionAt).HasColumnOrder(37);
