...
{
    /// <inheritdoc />
    public partial class CreateRoleTables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RoleAudits_ActionTypes_ActionTypeId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_RoleAudits_StatusTypes_StatusTypeId",
                        column: x => x.StatusTypeId,
                        principalTable: "StatusTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoleAudits_ActionTypeId",
                table: "RoleAudits",
                column: "ActionTypeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoleAudits_StatusTypeId",
                table: "RoleAudits",
                column: "StatusTypeId");
