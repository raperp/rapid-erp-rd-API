...
public class RoleService(RapidERPDbContext context, ISharedService shared) : IRoleService
{
    ...
    public Task<RequestResponse> Create(RolePOST masterPOST)
    {
    ...
    public Task<RequestResponse> Import(List<RolePUT> imports)
    {
        throw new NotImplementedException();
    }
    ...
    public Task<RequestResponse> Update(RolePUT masterPUT)
    {
        throw new NotImplementedException();
    }
