...
public class RiderService(RapidERPDbContext context, ISharedService shared) : IRiderService
{
    ...
    public Task<RequestResponse> Create(RiderPOST masterPOST)
    {
    ...
    public Task<RequestResponse> Import(List<RiderPUT> imports)
    {
        throw new NotImplementedException();
    }
    ...
    public Task<RequestResponse> Update(RiderPUT masterPUT)
    {
        throw new NotImplementedException();
    }
    ...
    //public async Task<RequestResponse> Create(RiderPOST masterPOST)
    //{
    //    try
    //    {
    ...
    //Task<RequestResponse> IBase<RiderPOST, RiderPUT>.GetById(int id)
    //{
    //    throw new NotImplementedException();
    //}
