...
public class DesignationService(RapidERPDbContext context, ISharedService shared) : IDesignationService
{
    ...
    public Task<RequestResponse> Create(DesignationPOST masterPOST)
    {
    ...
    public Task<RequestResponse> Import(List<DesignationPUT> imports)
    {
        throw new NotImplementedException();
    }
    ...
    public Task<RequestResponse> Update(DesignationPUT masterPUT)
    {
        throw new NotImplementedException();
    }
    ...
    //public async Task<RequestResponse> Create(DesignationPOST masterPOST)
    //{
    //    try
    //    {
    ...
    //        if (skip == 0 || take == 0)
    //        {
    //            result.Count = await shared.GetCounts<Designation>(pageSize);
    ...
    //Task<RequestResponse> IBase<DesignationPOST, DesignationPUT>.GetById(int id)
    //{
    //    throw new NotImplementedException();
    //}
