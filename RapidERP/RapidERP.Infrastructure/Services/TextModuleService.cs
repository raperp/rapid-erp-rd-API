...
public class TextModuleService(RapidERPDbContext context, ISharedService shared) : ITextModuleService
{
    ...
    public Task<RequestResponse> Create(TextModulePOST masterPOST)
    {
    ...
    public Task<RequestResponse> Import(List<TextModulePUT> imports)
    {
        throw new NotImplementedException();
    }
    ...
    public Task<RequestResponse> Update(TextModulePUT masterPUT)
    {
        throw new NotImplementedException();
    }
