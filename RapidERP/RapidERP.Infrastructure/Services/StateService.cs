...
public class StateService(RapidERPDbContext context, ISharedService shared) : IStateService
{
    ...
    public Task<RequestResponse> Create(StatePOST masterPOST)
    {
    ...
    public Task<RequestResponse> Import(List<StatePUT> imports)
    {
        throw new NotImplementedException();
    }
    ...
    public Task<RequestResponse> Update(StatePUT masterPUT)
    {
        throw new NotImplementedException();
    }
