...
public class CurrencyService(RapidERPDbContext context, ISharedService shared) : ICurrencyService
{
    ...
    public Task<RequestResponse> Create(CurrencyPOST masterPOST)
    {
    ...
    public Task<RequestResponse> Import(List<CurrencyPUT> imports)
    {
        throw new NotImplementedException();
    }
    ...
    public Task<RequestResponse> Update(CurrencyPUT masterPUT)
    {
        throw new NotImplementedException();
    }
