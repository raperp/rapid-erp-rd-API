...
public class SubmoduleService(RapidERPDbContext context, ISharedService shared) : ISubmoduleService
{
    ...
    public Task<RequestResponse> Create(SubmodulePOST masterPOST)
    {
    ...
    public Task<RequestResponse> Import(List<SubmodulePUT> imports)
    {
        throw new NotImplementedException();
    }
    ...
    public Task<RequestResponse> Update(SubmodulePUT masterPUT)
    {
        throw new NotImplementedException();
    }
