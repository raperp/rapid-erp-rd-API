...
public class MessageModuleService(RapidERPDbContext context, ISharedService shared) : IMessageModuleService
{
    ...
    public Task<RequestResponse> Create(MessageModulePOST masterPOST)
    {
    ...
    public Task<RequestResponse> Import(List<MessageModulePUT> imports)
    {
        throw new NotImplementedException();
    }
    ...
    public Task<RequestResponse> Update(MessageModulePUT masterPUT)
    {
        throw new NotImplementedException();
    }
