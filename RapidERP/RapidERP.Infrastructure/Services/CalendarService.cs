...
public class CalendarService(RapidERPDbContext context, ISharedService shared) : ICalendarService
{
    ...
    public Task<RequestResponse> Create(CalendarPOST masterPOST)
    {
    ...
    public Task<RequestResponse> Import(List<CalendarPUT> imports)
    {
        throw new NotImplementedException();
    }
    ...
    public Task<RequestResponse> Update(CalendarPUT masterPUT)
    {
        throw new NotImplementedException();
    }
