...
public class MenuModuleService(RapidERPDbContext context, ISharedService shared) : IMenuModuleService
{
    ...
    public Task<RequestResponse> Create(MenuModulePOST masterPOST)
    {
    ...
    public Task<RequestResponse> Import(List<MenuModulePUT> imports)
    {
        throw new NotImplementedException();
    }
    ...
    public Task<RequestResponse> Update(MenuModulePUT masterPUT)
    {
        throw new NotImplementedException();
    }
