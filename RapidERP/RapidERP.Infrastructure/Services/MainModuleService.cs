...
public class MainModuleService(RapidERPDbContext context, ISharedService shared) : IMainModuleService
{
    ...
    public Task<RequestResponse> Create(MainModulePOST masterPOST)
    {
    ...
    public Task<RequestResponse> Import(List<MainModulePUT> imports)
    {
        throw new NotImplementedException();
    }
    ...
    public Task<RequestResponse> Update(MainModulePUT masterPUT)
    {
        throw new NotImplementedException();
    }
    ...
    //public async Task<RequestResponse> Create(MainModulePOST masterPOST)
    //{
    //    try
    //    {
    ...
    //Task<RequestResponse> IBase<MainModulePOST, MainModulePUT>.GetById(int id)
    //{
    //    throw new NotImplementedException();
    //}
