...
public class UserIPWhitelistService(RapidERPDbContext context, ISharedService shared) : IUserIPWhitelistService
{
    ...
    public Task<RequestResponse> Create(UserIPWhitelistPOST masterPOST)
    {
    ...
    public Task<RequestResponse> Import(List<UserIPWhitelistPUT> imports)
    {
        throw new NotImplementedException();
    }
    ...
    public Task<RequestResponse> Update(UserIPWhitelistPUT masterPUT)
    {
        throw new NotImplementedException();
    }
