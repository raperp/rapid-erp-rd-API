...
public class OrderTypeService(RapidERPDbContext context, ISharedService shared) : IOrderTypeService
{
    ...
    public Task<RequestResponse> Create(OrderTypePOST masterPOST)
    {
    ...
    public Task<RequestResponse> Import(List<OrderTypePUT> imports)
    {
        throw new NotImplementedException();
    }
    ...
    public Task<RequestResponse> Update(OrderTypePUT masterPUT)
    {
        throw new NotImplementedException();
    }
