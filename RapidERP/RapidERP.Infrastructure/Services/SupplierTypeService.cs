...
public class SupplierTypeService(RapidERPDbContext context, ISharedService shared) : ISupplierTypeService
{
    ...
    public Task<RequestResponse> Create(SupplierTypePOST masterPOST)
    {
    ...
    public Task<RequestResponse> Import(List<SupplierTypePUT> imports)
    {
        throw new NotImplementedException();
    }
    ...
    public Task<RequestResponse> Update(SupplierTypePUT masterPUT)
    {
        throw new NotImplementedException();
    }
