...
public class SalesmanService(RapidERPDbContext context, ISharedService shared) : ISalesmanService
{
    ...
    public Task<RequestResponse> Create(SalesmanPOST masterPOST)
    {
    ...
    public Task<RequestResponse> Import(List<SalesmanPUT> imports)
    {
        throw new NotImplementedException();
    }
    ...
    public Task<RequestResponse> Update(SalesmanPUT masterPUT)
    {
        throw new NotImplementedException();
    }
    ...
    //public async Task<RequestResponse> Create(SalesmanPOST masterPOST)
    //{
    //    try
    //    {
    ...
    //Task<RequestResponse> IBase<SalesmanPOST, SalesmanPUT>.GetById(int id)
    //{
    //    throw new NotImplementedException();
    //}
