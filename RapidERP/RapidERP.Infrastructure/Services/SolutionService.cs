...
public class SolutionService(RapidERPDbContext context, ISharedService shared) : ISolutionService
{
    ...
    public Task<RequestResponse> Create(SolutionPOST masterPOST)
    {
    ...
    public Task<RequestResponse> Import(List<SolutionPUT> imports)
    {
        throw new NotImplementedException();
    }
    ...
    public Task<RequestResponse> Update(SolutionPUT masterPUT)
    {
        throw new NotImplementedException();
    }
