...
namespace RapidERP.Infrastructure.Services
{
    public class KitchenService(RapidERPDbContext context, ISharedService shared) : IKitchenService
    {
        ...
        public Task<RequestResponse> Create(KitchenPOST masterPOST)
        {
        ...
        public Task<RequestResponse> Import(List<KitchenPUT> imports)
        {
            throw new NotImplementedException();
        }
        ...
        public Task<RequestResponse> Update(KitchenPUT masterPUT)
        {
            throw new NotImplementedException();
        }
