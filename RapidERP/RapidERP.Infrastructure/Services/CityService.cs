...
public class CityService(RapidERPDbContext context, ISharedService shared) : ICityService
{
    ...
    public Task<RequestResponse> Create(CityPOST masterPOST)
    {
    ...
    public Task<RequestResponse> Import(List<CityPUT> imports)
    {
        throw new NotImplementedException();
    }
    ...
    public Task<RequestResponse> Update(CityPUT masterPUT)
    {
        throw new NotImplementedException();
    }
