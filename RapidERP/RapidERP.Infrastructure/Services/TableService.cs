...
public class TableService(RapidERPDbContext context, ISharedService shared) : ITableService
{
    ...
    public Task<RequestResponse> Create(TablePOST masterPOST)
    {
    ...
    public Task<RequestResponse> Import(List<TablePUT> imports)
    {
        throw new NotImplementedException();
    }
    ...
    public Task<RequestResponse> Update(TablePUT masterPUT)
    {
        throw new NotImplementedException();
    }
    ...
    //public async Task<RequestResponse> Create(TablePOST masterPOST)
    //{
    //    try
    //    {
    ...
    //Task<RequestResponse> IBase<TablePOST, TablePUT>.GetById(int id)
    //{
    //    throw new NotImplementedException();
    //}
