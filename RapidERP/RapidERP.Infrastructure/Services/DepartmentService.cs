...
public class DepartmentService(RapidERPDbContext context, ISharedService shared) : IDepartmentService
{
    ...
    public Task<RequestResponse> Create(DepartmentPOST masterPOST)
    {
    ...
    public Task<RequestResponse> Import(List<DepartmentPUT> imports)
    {
        throw new NotImplementedException();
    }
    ...
    public Task<RequestResponse> Update(DepartmentPUT masterPUT)
    {
        throw new NotImplementedException();
    }
