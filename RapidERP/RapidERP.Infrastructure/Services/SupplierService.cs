...
public class SupplierService(RapidERPDbContext context, ISharedService shared) : ISupplierService
{
    ...
    public Task<RequestResponse> Create(SupplierPOST masterPOST)
    {
    ...
    public Task<RequestResponse> Import(List<SupplierPUT> imports)
    {
        throw new NotImplementedException();
    }
    ...
    public Task<RequestResponse> Update(SupplierPUT masterPUT)
    {
        throw new NotImplementedException();
    }
    ...
    //public async Task<RequestResponse> Create(SupplierPOST masterPOST)
    //{
    //    try
    //    {
    ...
    //Task<RequestResponse> IBase<SupplierPOST, SupplierPUT>.GetById(int id)
    //{
    //    throw new NotImplementedException();
    //}
