...
public class TenantCalendarService(RapidERPDbContext context, ISharedService shared) : ITenantCalendarService
{
    ...
    public Task<RequestResponse> Create(TenantCalendarPOST masterPOST)
    {
    ...
    public Task<RequestResponse> Import(List<TenantCalendarPUT> imports)
    {
        throw new NotImplementedException();
    }
    ...
    public Task<RequestResponse> Update(TenantCalendarPUT masterPUT)
    {
        throw new NotImplementedException();
    }
