...
public class TenantLicenseService(RapidERPDbContext context, ISharedService shared) : ITenantLicenseService
{
    ...
    public Task<RequestResponse> Create(TenantLicensePOST masterPOST)
    {
    ...
    public Task<RequestResponse> Import(List<TenantLicensePUT> imports)
    {
        throw new NotImplementedException();
    }
    ...
    public Task<RequestResponse> Update(TenantLicensePUT masterPUT)
    {
        throw new NotImplementedException();
    }
