...
public class TenantService(RapidERPDbContext context, ISharedService shared) : ITenantService
{
    ...
    public Task<RequestResponse> Create(TenantPOST masterPOST)
    {
    ...
    public Task<RequestResponse> Import(List<TenantPUT> imports)
    {
        throw new NotImplementedException();
    }
    ...
    public Task<RequestResponse> Update(TenantPUT masterPUT)
    {
        throw new NotImplementedException();
    }
    ...
    //public async Task<RequestResponse> Create(TenantPOST masterPOST)
    //{
    //    try
    //    {
    ...
    //Task<RequestResponse> IBase<TenantPOST, TenantPUT>.GetById(int id)
    //{
    //    throw new NotImplementedException();
    //}
