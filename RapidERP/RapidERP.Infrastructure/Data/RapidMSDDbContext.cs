...
public class RapidMSDDbContext(DbContextOptions<RapidMSDDbContext> options) : DbContext(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.ApplyConfigurationsFromAssembly(typeof(RapidMSDDbContext).Assembly);
    }
}
